...
<xsl:template match="foreignphrase">
  <xsl:choose>
    <xsl:when test="@lang = 'ja'">
      <fo:inline font-style="normal" font-family="MS Mincho">
        <xsl:apply-templates/>
      </fo:inline>
    </xsl:when>
    <xsl:when test="@lang = 'ar'">
      <fo:inline font-style="normal" font-family="Times New Roman">
        <xsl:apply-templates/>
      </fo:inline>
    </xsl:when>
    <xsl:when test="@lang = 'cs'">
      <fo:inline font-style="normal" font="Courier New" language="cs">
        <xsl:apply-templates/>
      </fo:inline>
    </xsl:when>
    <xsl:otherwise>
