...
<xsl:template name="article.titlepage.recto">
  ...
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/releaseinfo[not(@role) or (@role != 'namespaces' and                                               @role != 'track' and                                               @role != 'topic')]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/releaseinfo[not(@role) or (@role != 'namespaces' and                                               @role != 'track' and                                               @role != 'topic')]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/releaseinfo[not(@role) or (@role != 'namespaces' and                                               @role != 'track' and                                               @role != 'topic')]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/authorgroup"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/authorgroup"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/authorgroup"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/legalnotice[@role = 'additional']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/legalnotice[@role = 'additional']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/legalnotice[@role = 'additional']"/>
  ...
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/legalnotice[not(@role) or (@role != 'status' and                                               @role != 'related' and                                               @role != 'additional' and                                               @role != 'notices' and                                               @role != 'citation' )]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/legalnotice[not(@role) or (@role != 'status' and                                               @role != 'related' and                                               @role != 'additional' and                                               @role != 'notices' and                                               @role != 'citation' )]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/legalnotice[not(@role) or (@role != 'status' and                                               @role != 'related' and                                               @role != 'additional' and                                               @role != 'notices' and                                               @role != 'citation' )]"/>
  ...
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/legalnotice[@role = 'citation']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/legalnotice[@role = 'citation']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/legalnotice[@role = 'citation']"/>
...
<xsl:template name="article.titlepage.before.recto"><fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" text-align="start">
      <fo:external-graphic src="url(&#34;{$oasis.logo}&#34;)"/>
    </fo:block>
</xsl:template>
