...
<xsl:template name="article.titlepage.recto">
  ...
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/legalnotice[not(@role) or (@role != 'status' and                                               @role != 'additional' and                                               @role != 'related' and                                               @role != 'notices' and                                               @role != 'citation' )]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/legalnotice[not(@role) or (@role != 'status' and                                               @role != 'additional' and                                               @role != 'related' and                                               @role != 'notices' and                                               @role != 'citation' )]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/legalnotice[not(@role) or (@role != 'status' and                                               @role != 'additional' and                                               @role != 'related' and                                               @role != 'notices' and                                               @role != 'citation' )]"/>
